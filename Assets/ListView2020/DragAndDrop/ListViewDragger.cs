...
namespace UnityEngine.UIElements2020
{
    internal class ListViewDragger : DragEventsProcessor
    {
        internal struct DragPosition : IEquatable<DragPosition>
        {
            ...
            public ListView2020.RecycledItem recycledItem;
        ...
        private ListView2020 targetListView
        {
            get { return m_Target as ListView2020; }
        }
        ...
        public ListViewDragger(ListView2020 listView) : base(listView)
        {
            m_DragHoverBar = new VisualElement();
            m_DragHoverBar.AddToClassList(ListView2020.dragHoverBarUssClassName);
        ...
        protected void ApplyDragAndDropUI(DragPosition dragPosition)
        {
            ...
            switch (dragPosition.dragAndDropPosition)
            {
                case DragAndDropPosition.OverItem:
                    dragPosition.recycledItem.element.AddToClassList(ListView2020.itemDragHoverUssClassName);
                    break;
        ...
        protected override void ClearDragAndDropUI()
        {
            ...
            {
                item.element.RemoveFromClassList(ListView2020.itemDragHoverUssClassName);
            }

            m_DragHoverBar.style.visibility = Visibility.Hidden;
        }

        private ListView2020.RecycledItem GetRecycledItem(Vector3 pointerPosition)
        {
    ...
    {
        public static ListView2020.RecycledItem GetRecycledItemFromIndex(this ListView2020 listView, int index)
        {
