...
namespace UnityEngine.UIElements2020
{
    ...
    /// </code>
    /// </example>
    public class ListView2020 : BindableElement, ISerializationCallbackReceiver
    {
        /// <summary>
        /// Instantiates a <see cref="ListView"/> using the data read from a UXML file.
        /// </summary>
        public new class UxmlFactory : UxmlFactory<ListView2020, UxmlTraits> {}

        /// <summary>
        /// Defines <see cref="UxmlTraits"/> for the <see cref="ListView2020"/>.
        /// </summary>
        public new class UxmlTraits : BindableElement.UxmlTraits
        {
            ...
            /// <summary>
            /// Initialize <see cref="ListView2020"/> properties using values from the attribute bag.
            /// </summary>
        ...
        /// </summary>
        /// <seealso cref="ListView2020.itemHeight"/>
        ...
        /// <summary>
        /// ListView2020 requires all visual elements to have the same height so that it can calculate a sensible scroller size. This property must be set for the list view to function.
        /// </summary>
        ...
        /// <summary>
        /// Enable this property to display a border around the ListView2020.
        /// </summary>
        ...
        public ListView2020(IList itemsSource, int itemHeight, Func<VisualElement> makeItem, Action<VisualElement, int> bindItem) : this()
        {
